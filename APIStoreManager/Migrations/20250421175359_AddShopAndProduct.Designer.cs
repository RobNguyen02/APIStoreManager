...
namespace APIStoreManager.Migrations
{
    ...
    [Migration("20250421175359_AddShopAndProduct")]
    partial class AddShopAndProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIStoreManager.Model.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APIStoreManager.Models.Shop", b =>
                {
                    b.HasOne("APIStoreManager.Model.User", "Owner")
                        .WithMany()
